...
const 流程 = () => {
    ...
    const 初始可持仓额度 =
        Math.floor(((可持仓资金 / 交易行业总数) * 1.32) / 10000) * 10000
    const 一次补仓额度 = 初始可持仓额度 * 一次补仓系数
    const 第一补仓后额度 = 初始可持仓额度 + 一次补仓额度
    const 第二次补仓后额度 = 第一补仓后额度 + 一次补仓额度
    const 最大可持仓额度 = 第二次补仓后额度

    const 第一次补仓亏损临界额度 = 初始可持仓额度 * 可补仓亏损边界
    const 第二次补仓亏损临界额度 =
        初始可持仓额度 * (可补仓亏损边界 * 2) + 一次补仓额度 * 可补仓亏损边界
